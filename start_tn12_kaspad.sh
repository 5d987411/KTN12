#!/bin/bash
# Start Kaspa Testnet 12 Node (NEW tn12-built binary)

SCRIPT_DIR="$(cd "$(dirname "$0")" && pwd)"
KASPAD_BIN="/Users/4dsto/rusty-kaspa-tn12/target/release/kaspad"

echo "Starting Kaspa Testnet 12 node (tn12 build)..."
